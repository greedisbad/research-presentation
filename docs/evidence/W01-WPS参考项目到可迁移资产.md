...
2026-09-08 GitHub API 复核发现：四个重点参考仓库均未归档，但 `slidev-ppt-agent` 未检测到许可证；其余三个分别显示 MIT、MIT 与 Apache-2.0。维护活跃与许可证只是筛选字段，不是质量证明；没有明确许可证的仓库只能先借鉴思想，复制代码前需另行核验。详见[易变事实复核](../sources/volatile-fact-check-2026-09-08.md)。
